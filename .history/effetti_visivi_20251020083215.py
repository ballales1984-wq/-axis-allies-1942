...
class MissileAnimation:
    """Animazione missili a lungo raggio"""
    
    def __init__(self, start_pos, end_pos):
        self.start_x, self.start_y = start_pos
        self.end_x, self.end_y = end_pos
        self.progress = 0
        self.max_progress = 60
        self.active = True
        self.trail = []
    ...
    def update(self):
        ...
        # Posizione corrente
        t = self.progress / self.max_progress
    ...
    def draw(self, surface):
        ...
        for i, (x, y) in enumerate(self.trail):
            ...
            pygame.draw.circle(s, (255, 200, 0, alpha), (size, size), size)
            surface.blit(s, (int(x) - size, int(y) - size))
