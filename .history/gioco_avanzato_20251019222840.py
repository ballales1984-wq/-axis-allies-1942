...
class BuyMenu:
    ...
    def draw(self, surface, font, font_small):
        ...
        # Fanteria con icona
        self.draw_unit_icon(surface, "fanteria", self.x + 25, self.y + 195, 25)
        inf_text = font_small.render(f"x{counts['fanteria']}", True, (255, 255, 255))
        surface.blit(inf_text, (self.x + 55, self.y + 200))
        
        # Carri con icona
        self.draw_unit_icon(surface, "carro", self.x + 105, self.y + 195, 25)
        tank_text = font_small.render(f"x{counts['carro']}", True, (255, 255, 255))
        surface.blit(tank_text, (self.x + 135, self.y + 200))
        
        # Aerei con icona
        self.draw_unit_icon(surface, "aereo", self.x + 185, self.y + 195, 25)
        plane_text = font_small.render(f"x{counts['aereo']}", True, (255, 255, 255))
        surface.blit(plane_text, (self.x + 215, self.y + 200))
        
        # Totale
        total_units = len(self.territory.units)
        total_text = font_small.render(f"TOT: {total_units}", True, (255, 215, 100))
        surface.blit(total_text, (self.x + 265, self.y + 200))
