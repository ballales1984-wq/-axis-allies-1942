...
class Game:
    ...
    def __init__(self):
        ...
        # SCHERMO GRANDE e RIDIMENSIONABILE
        self.screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT), pygame.RESIZABLE)
        pygame.display.set_caption("Axis & Allies 1942 - ALLEANZE MONDIALI [F11=Fullscreen]")
                    ...
                    if self.command_console:
                        ...
                        if event.key == pygame.K_ESCAPE:
                            ...
                            if self.fullscreen:
                                ...
                                self.show_message("FULLSCREEN attivo! (F11 per uscire)")
                            else:
                                self.screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT), pygame.RESIZABLE)
                                self.show_message("Finestra normale")
