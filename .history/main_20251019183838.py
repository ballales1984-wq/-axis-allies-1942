...
def crea_griglia_da_mappa():
    ...
    # Usa mappa Axis & Allies vera!
    try:
        img = Image.open("mappa_axis_allies.png")
        print(f"[OK] Uso mappa AXIS & ALLIES VERA!")
    except:
        try:
            img = Image.open("mappa_solo_confini.png")
            print(f"[OK] Uso mappa solo confini")
        except:
            try:
                img = Image.open("mappa.png")
                print(f"[OK] Uso mappa standard")
            except:
