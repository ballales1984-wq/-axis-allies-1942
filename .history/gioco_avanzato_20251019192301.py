...
class BuyMenu:
    ...
    def draw_buy_button(self, surface, font, font_small, unit_type, stats, x, y, number):
        """Disegna PULSANTE acquisto grande e chiaro"""
        button_width = 320
        button_height = 85
        
        # Sfondo pulsante con colore
        if unit_type == "fanteria":
            bg_color = (60, 80, 60)
            hover_color = (80, 120, 80)
        elif unit_type == "carro":
            bg_color = (80, 70, 50)
            hover_color = (120, 100, 70)
        else:  # aereo
            bg_color = (50, 60, 90)
            hover_color = (70, 90, 130)
        
        pygame.draw.rect(surface, bg_color, (x, y, button_width, button_height))
        pygame.draw.rect(surface, (255, 200, 50), (x, y, button_width, button_height), 2)
    ...
    def draw_repair_button(self, surface, font, font_small, x, y):
        """Pulsante RIPARA grande"""
        button_width = 320
        button_height = 50
        
        # Sfondo arancione
        pygame.draw.rect(surface, (100, 60, 20), (x, y, button_width, button_height))
        pygame.draw.rect(surface, (255, 150, 50), (x, y, button_width, button_height), 3)
